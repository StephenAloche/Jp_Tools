...
namespace HiraKana
{
    ...
    public static class KanaTools
    {
        ...
        // Options
        private static bool _imeMode;
        private static bool _useObsoleteKana;
        /*
        public KanaTools() { }
        ...
        */
        /* Public static API */
        public static string OnTheFlyToKana(string input, bool hiragana = true, bool katakana = false)
        {
        ...
        private static bool IsCharKana(char chr)
        {
        ...
        private static string RomajiToHiragana(string romaji)
        {
            return RomajiToKana(romaji);
        }

        // TODO: move ignore case to options?
        private static string RomajiToKana(string romaji, bool ignoreCase = true)
        {
            var chunk = "";
            var chunkLc = "";
            var position = 0;
        ...
        public static string HiraganaToRomaji(string hira)
        {
            if (IsRomaji(hira))
            {
                return hira;
